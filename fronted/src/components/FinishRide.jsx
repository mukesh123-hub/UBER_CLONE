...
const FinishRide = (props) => {
  ...
  return (
    <div >
         ...
         <div className='flex items-center justify-between p-4 border-yellow-400 rounded-lg mt-4'>
         ...
         <div className='flex gap-2 justify-between flex-col items-center'>
            ...
            <div className='mt-6 w-full'>
               ...
               <button to='/captain-home'
                onClick={endRide}
               className='w-full mt-5 flex text-lg justify-center bg-green-500 text-white font-semibold p-3 rounded-lg'>Complete Ride</button>
